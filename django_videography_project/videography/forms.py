...
class LinkForm(forms.Form):
    ...
    #search_term = forms.CharField(label='Image Search Term:', max_length=100, widget=forms.TextInput(attrs={'rows':1, 'class': 'form-control'}))
    caption_bool = forms.BooleanField(label='Use YouTube Captions:', required=False)
